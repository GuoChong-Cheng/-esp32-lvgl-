...
void lv_port_disp_init(void)
{
    ...
    // disp_drv.rotated   = LV_DISP_ROT_90; // 不要用软件旋屏
...
static void disp_init(void)
{
    Serial.println("[LVGL] inst_lcd. init...");
}
...
static void disp_flush(lv_disp_drv_t* disp_drv, const lv_area_t* area, lv_color_t* color_p)
{
    ...
    inst_lcd.set_window(area->x1, area->y1, area->x2, area->y2);
    inst_lcd.write_colors((uint16_t*)&color_p->full, lv_area_get_size(area));
